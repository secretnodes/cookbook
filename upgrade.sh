...
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/install-docker.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/install-sgx.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/uninstall-sgx.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/start.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/install-enigma-node.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/sendnodes.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/install-fixes.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/update-discovery-testnet.sh"
sleep 1
curl -O "https://raw.githubusercontent.com/secretnodes/scripts/master/cli.sh"
